...
typedef struct tPERSONAL_DATA
{
	...
	struct
	{
		...
		u16 defaultBrightness	: 2;	//!<	Brightness level at power on, dslite.
		u16 autoMode			: 1;	//!<	The DS should boot from the DS cart or GBA cart automatically if one is inserted.
		u16 RESERVED5			: 2;	//	???
